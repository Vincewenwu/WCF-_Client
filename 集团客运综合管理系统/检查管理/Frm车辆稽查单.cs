...
{
    public partial class Frm车辆稽查单 : Form
    {
        public Frm车辆稽查单()
        {
            InitializeComponent();
        ...
        #endregion
        private void Frm车辆稽查单_Load(object sender, EventArgs e)
        {
        ...
        {
            string VehiclePaiNumber = textBox1.Text.Trim();
            DataTable dt = mychezhanjichaClient.selectcheliangjichadan(VehiclePaiNumber).Tables[0];
            dataGridView1.DataSource = dt;
        }

        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            DataTable dt = mychezhanjichaClient.selectjichaxiangmu(Convert .ToInt32 ( dataGridView1.CurrentRow.Cells["TheStationInspectionID"].Value) ).Tables[0];
